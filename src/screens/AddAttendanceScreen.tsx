  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.row}>
        ...
        >
          <Text style={[styles.chipText, status === "present" && styles.chipTextActive]}>Presente</Text>
        </Pressable>
        ...
        >
          <Text style={[styles.chipText, status === "late" && styles.chipTextActive]}>Tarde</Text>
        </Pressable>
        ...
        >
          <Text style={[styles.chipText, status === "absent" && styles.chipTextActive]}>Falta</Text>
        </Pressable>
      </View>
...
const styles = StyleSheet.create({
  ...
  chip: { borderWidth: 1, borderColor: "#ddd", paddingVertical: 10, paddingHorizontal: 12, borderRadius: 999 },
